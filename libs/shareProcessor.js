...
module.exports = function(logger, poolConfig){
    ...
    this.handleShare = function(isValidShare, isValidBlock, shareData) {
        ...
        //shares,block reward(12.5),block diff,worker name,time
        var hashrateData = [isValidShare ? shareData.difficulty : -shareData.difficulty,
             shareData.coinbaseReward,
             shareData.blockDiff,
             shareData.worker, 
             dateNow];
        ...
        if (isValidBlock){
            ...
            */
            redisCommands.push(['sadd', coin + ':blocksPending', [shareData.blockHash, shareData.txHash, shareData.height, shareData.worker, dateNow,shareData.coinbaseReward].join(':')]);
